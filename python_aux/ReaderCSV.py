...
class ReaderCSV:
	...
	def ab_plot(
	    ...
	    self.print_dict(info_a)
	    print(f'Info for {name_b}:')
	    self.print_dict(info_b)
	    print(f'Time Measurements for {name_a}:')
	    self.print_dict(measurements(y_a))
	    print(f'FFT Measurements for {name_a}:')
	    self.print_dict(measurements(yf_a))
	    print(f'Time Measurements for {name_b}:')
	    self.print_dict(measurements(y_b))
	    print(f'FFT Measurements for {name_b}:')
	    self.print_dict(measurements(yf_b))
